...
for number in numbers :
 ...
 # 3-2. 튜플
languages = ("jaemin", "mark", "chenle")
for language in languages :
    print(language)

 # 3-3. 딕셔너리
fruittColors = {"apple" : "red", "banana" : "yellow", "cherry" : "red"}
for fruit, color in fruittColors.items():
    print(f"The color of {fruit} is {color}")

  # items()매서드는 딕셔너리의 모든 키-값 쌍을 반환하는 매서드
  # 키 : keys()
  # 값 : values()
