...
# 1. 상속의 정의
# : 한 클래스의 속성과 매서드를 다른 클래스에게 전달하는 형태(메커니즘)
# : 새로운 클래스는 기본 클래스의 모든 속성과 매서드를 받아들이고 추가적인 속성이나 매서드를 정의할 수 있음

# 상속 받는다 - 다른 클래스의 기능을 물려받음
...
# 2. 상속의 필요성
# 2-1. 재사용성
# : 이미 정의된 클래스의 속성과 매서드를 재사용해서 코드 중복을 줄임
