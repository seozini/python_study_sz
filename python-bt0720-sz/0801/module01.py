...
from my_module import greet,info
print(greet("seozin"))
print(info(20))

 # 3-3. import as 사용
  # : 모듈의 이름이 같거나 다른 모듈과 충돌할 가능성이 있는 경우
  # : 모듈에 대한 별칭(alias)을 지정하는 것이 유용
  # as 키워드를 사용하여 별칭 지정 가능

import my_module as mk

print(mk.add(8, 2))
print(mk.sub(8, 13))

from my_module import greet as hello
# my_module 모듈 안의 greet 항목을 hello 별칭으로 사용
